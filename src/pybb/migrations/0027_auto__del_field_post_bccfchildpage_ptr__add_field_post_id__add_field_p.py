...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.bccfchildpage_ptr'
        db.delete_column(u'pybb_post', u'bccfchildpage_ptr_id')

        # Adding field 'Post.id'
        db.add_column(u'pybb_post', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Adding field 'Post.topic'
        db.add_column(u'pybb_post', 'topic',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='posts', to=orm['pybb.Topic']),
                      keep_default=False)

        # Adding field 'Post.created'
        db.add_column(u'pybb_post', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 20, 0, 0), db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.updated'
        db.add_column(u'pybb_post', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Topic.updated'
        db.delete_column(u'pybb_topic', 'updated')

        # Deleting field 'Topic.created'
        db.delete_column(u'pybb_topic', 'created')

        # Deleting field 'Topic.id'
        db.delete_column(u'pybb_topic', u'id')

        # Adding field 'Topic.bccfchildpage_ptr'
        db.add_column(u'pybb_topic', u'bccfchildpage_ptr',
    ...
    def backwards(self, orm):
        # Adding field 'Post.bccfchildpage_ptr'
        db.add_column(u'pybb_post', u'bccfchildpage_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['bccf.BCCFChildPage'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'Post.id'
        db.delete_column(u'pybb_post', u'id')

        # Deleting field 'Post.topic'
        db.delete_column(u'pybb_post', 'topic_id')

        # Deleting field 'Post.created'
        db.delete_column(u'pybb_post', 'created')

        # Deleting field 'Post.updated'
        db.delete_column(u'pybb_post', 'updated')

        # Adding field 'Topic.updated'
        db.add_column(u'pybb_topic', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Topic.created'
        db.add_column(u'pybb_topic', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Topic.id'
        db.add_column(u'pybb_topic', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Deleting field 'Topic.bccfchildpage_ptr'
        db.delete_column(u'pybb_topic', u'bccfchildpage_ptr_id')
