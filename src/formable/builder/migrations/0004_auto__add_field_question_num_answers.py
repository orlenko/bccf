...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.num_answers'
        db.add_column(u'builder_question', 'num_answers',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.num_answers'
        db.delete_column(u'builder_question', 'num_answers')
    ...
    models = {
        ...
        u'builder.question': {
            ...
            'form_published': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['builder.FormPublished']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'num_answers': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
