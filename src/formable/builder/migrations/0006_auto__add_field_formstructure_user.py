...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormStructure.user'
        db.add_column(u'builder_formstructure', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormStructure.user'
        db.delete_column(u'builder_formstructure', 'user_id')
