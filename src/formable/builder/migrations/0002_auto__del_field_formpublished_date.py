...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FormPublished.date'
        db.delete_column(u'builder_formpublished', 'date')


    def backwards(self, orm):
        # Adding field 'FormPublished.date'
        db.add_column(u'builder_formpublished', 'date',
