...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormPublished.closed'
        db.add_column(u'builder_formpublished', 'closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormPublished.closed'
        db.delete_column(u'builder_formpublished', 'closed')
