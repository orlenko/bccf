...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FormPublished.title'
        db.delete_column(u'builder_formpublished', 'title')

        # Deleting field 'FormPublished.published'
        db.delete_column(u'builder_formpublished', 'published')

        # Deleting field 'FormPublished.id'
        db.delete_column(u'builder_formpublished', u'id')

        # Adding field 'FormPublished.bccfchildpage_ptr'
        db.add_column(u'builder_formpublished', u'bccfchildpage_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['bccf.BCCFChildPage'], unique=True, primary_key=True),
                      keep_default=False)


        # Changing field 'Question.num_answers'
        db.alter_column(u'builder_question', 'num_answers', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
        # Adding field 'FormPublished.title'
        db.add_column(u'builder_formpublished', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'FormPublished.published'
        db.add_column(u'builder_formpublished', 'published',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=1, blank=True),
                      keep_default=False)

        # Adding field 'FormPublished.id'
        db.add_column(u'builder_formpublished', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Deleting field 'FormPublished.bccfchildpage_ptr'
        db.delete_column(u'builder_formpublished', u'bccfchildpage_ptr_id')


        # Changing field 'Question.num_answers'
        db.alter_column(u'builder_question', 'num_answers', self.gf('django.db.models.fields.IntegerField')(null=True))
