...
class Order(models.Model):
    ...
    billing_detail_province = CharField(_("Province/State"), max_length=100)
    billing_detail_postal_code = CharField(_("Postal Code"), max_length=10)
    billing_detail_country = CharField(_("Country"), max_length=100)
    billing_detail_phone_primary = CharField(_("Phone"), max_length=20)
    ...
    shipping_detail_province = CharField(_("Province/State"), max_length=100)
    shipping_detail_postal_code = CharField(_("Postal Code"), max_length=10)
    shipping_detail_country = CharField(_("Country"), max_length=100)
    shipping_detail_phone_primary = CharField(_("Phone"), max_length=20)
    ...
    def setup(self, request):
        ...
        if self.shipping_total is not None:
            self.shipping_total = Decimal(self.shipping_total)
