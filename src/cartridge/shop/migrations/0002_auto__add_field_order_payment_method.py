...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'shop_order', 'payment_method',
                      self.gf('django.db.models.fields.CharField')(default='paypal', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.payment_method'
        db.delete_column(u'shop_order', 'payment_method')
