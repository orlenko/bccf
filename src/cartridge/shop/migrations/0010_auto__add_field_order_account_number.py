...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.account_number'
        db.add_column(u'shop_order', 'account_number',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.account_number'
        db.delete_column(u'shop_order', 'account_number')
