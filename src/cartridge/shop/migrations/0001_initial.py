...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'shop_productvariation', (
            ...
            ('option3', self.gf('cartridge.shop.fields.OptionField')(max_length=50, null=True)),
            ('option4', self.gf('cartridge.shop.fields.OptionField')(max_length=50, null=True)),
            ('option5', self.gf('cartridge.shop.fields.OptionField')(max_length=50, null=True)),
        ))
        ...
        db.create_table(u'shop_discountcode', (
            ...
            ('free_shipping', self.gf('django.db.models.fields.BooleanField')()),
