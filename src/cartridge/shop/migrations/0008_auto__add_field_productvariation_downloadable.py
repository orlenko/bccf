...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductVariation.downloadable'
        db.add_column(u'shop_productvariation', 'downloadable',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.ProductDownloadableContent'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductVariation.downloadable'
        db.delete_column(u'shop_productvariation', 'downloadable_id')
