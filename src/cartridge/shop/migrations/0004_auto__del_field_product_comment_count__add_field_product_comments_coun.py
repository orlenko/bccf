...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.comment_count'
        db.delete_column(u'shop_product', u'comment_count')

        # Adding field 'Product.comments_count'
        db.add_column(u'shop_product', u'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.comment_count'
        db.add_column(u'shop_product', u'comment_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Product.comments_count'
        db.delete_column(u'shop_product', u'comments_count')
