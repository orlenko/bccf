...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductVariation.tax_exempt'
        db.add_column(u'shop_productvariation', 'tax_exempt',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Product.tax_exempt'
        db.add_column(u'shop_product', 'tax_exempt',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductVariation.tax_exempt'
        db.delete_column(u'shop_productvariation', 'tax_exempt')

        # Deleting field 'Product.tax_exempt'
        db.delete_column(u'shop_product', 'tax_exempt')
