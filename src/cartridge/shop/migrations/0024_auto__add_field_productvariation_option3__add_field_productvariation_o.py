...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductVariation.option3'
        db.add_column(u'shop_productvariation', 'option3',
                      self.gf('cartridge.shop.fields.OptionField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'ProductVariation.option4'
        db.add_column(u'shop_productvariation', 'option4',
                      self.gf('cartridge.shop.fields.OptionField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'ProductVariation.option5'
        db.add_column(u'shop_productvariation', 'option5',
                      self.gf('cartridge.shop.fields.OptionField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductVariation.option3'
        db.delete_column(u'shop_productvariation', 'option3')

        # Deleting field 'ProductVariation.option4'
        db.delete_column(u'shop_productvariation', 'option4')

        # Deleting field 'ProductVariation.option5'
        db.delete_column(u'shop_productvariation', 'option5')
