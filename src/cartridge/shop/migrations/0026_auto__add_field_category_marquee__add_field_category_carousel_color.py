...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.marquee'
        db.add_column(u'shop_category', 'marquee',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bccf.PageMarquee'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.carousel_color'
        db.add_column(u'shop_category', 'carousel_color',
                      self.gf('django.db.models.fields.CharField')(default='dgreen-list', max_length=11),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.marquee'
        db.delete_column(u'shop_category', 'marquee_id')

        # Deleting field 'Category.carousel_color'
        db.delete_column(u'shop_category', 'carousel_color')
