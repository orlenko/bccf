...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventRegistration.paid'
        db.alter_column(u'bccf_eventregistration', 'paid', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'EventRegistration.paid'
        db.alter_column(u'bccf_eventregistration', 'paid', self.gf('django.db.models.fields.BooleanField')())
