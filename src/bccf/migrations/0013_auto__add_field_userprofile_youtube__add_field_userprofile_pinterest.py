...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.youtube'
        db.add_column(u'bccf_userprofile', 'youtube',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.pinterest'
        db.add_column(u'bccf_userprofile', 'pinterest',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.youtube'
        db.delete_column(u'bccf_userprofile', 'youtube')

        # Deleting field 'UserProfile.pinterest'
        db.delete_column(u'bccf_userprofile', 'pinterest')
