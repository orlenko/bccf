...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProgramRequest.accepted_on'
        db.add_column(u'bccf_programrequest', 'accepted_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'ProgramRequest.created'
        db.alter_column(u'bccf_programrequest', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):
        # Deleting field 'ProgramRequest.accepted_on'
        db.delete_column(u'bccf_programrequest', 'accepted_on')


        # Changing field 'ProgramRequest.created'
        db.alter_column(u'bccf_programrequest', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, null=True))
