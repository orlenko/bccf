...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Topic.featured_image'
        db.add_column(u'bccf_topic', 'featured_image',
                      self.gf('bccf.fields.MyImageField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomeMarqueeSlide.url'
        db.add_column(u'bccf_homemarqueeslide', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FooterMarqueeSlide.url'
        db.add_column(u'bccf_footermarqueeslide', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Topic.featured_image'
        db.delete_column(u'bccf_topic', 'featured_image')

        # Deleting field 'HomeMarqueeSlide.url'
        db.delete_column(u'bccf_homemarqueeslide', 'url')

        # Deleting field 'FooterMarqueeSlide.url'
        db.delete_column(u'bccf_footermarqueeslide', 'url')
