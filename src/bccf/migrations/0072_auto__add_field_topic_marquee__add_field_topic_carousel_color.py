...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Topic.carousel_color'
        db.add_column(u'bccf_topic', 'carousel_color',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Topic.carousel_color'
        db.delete_column(u'bccf_topic', 'carousel_color')
