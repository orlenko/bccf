...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BCCFPages'
        db.create_table(u'bccf_bccfpages', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['bccf.BCCFPages'])),
        ...
        db.send_create_signal(u'bccf', ['BCCFPages'])

        # Deleting field 'BCCFParentPage.bccfpage_ptr'
        db.delete_column(u'bccf_bccfparentpage', u'bccfpage_ptr_id')

        # Adding field 'BCCFParentPage.bccfpages_ptr'
        db.add_column(u'bccf_bccfparentpage', u'bccfpages_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['bccf.BCCFPages'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'BCCFChildPage.bccfpage_ptr'
        db.delete_column(u'bccf_bccfchildpage', u'bccfpage_ptr_id')

        # Adding field 'BCCFChildPage.bccfpages_ptr'
        db.add_column(u'bccf_bccfchildpage', u'bccfpages_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['bccf.BCCFPages'], unique=True, primary_key=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'bccf_bccfpage', (
            ...
            ('titles', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', null=True, to=orm['bccf.BCCFPage'], blank=True)),
            ('expiry_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('in_menus', self.gf('mezzanine.pages.fields.MenusField')(default=(1, 2, 3), max_length=100, null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
            ('gen_description', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        # Deleting model 'BCCFPages'
        db.delete_table(u'bccf_bccfpages')

        # Adding field 'BCCFParentPage.bccfpage_ptr'
        db.add_column(u'bccf_bccfparentpage', u'bccfpage_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['bccf.BCCFPage'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'BCCFParentPage.bccfpages_ptr'
        db.delete_column(u'bccf_bccfparentpage', u'bccfpages_ptr_id')
        ...
        # Deleting field 'BCCFChildPage.bccfpages_ptr'
        db.delete_column(u'bccf_bccfchildpage', u'bccfpages_ptr_id')
    ...
    models = {
        ...
        u'bccf.bccfchildpage': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'BCCFChildPage', '_ormbases': [u'bccf.BCCFPages']},
            u'bccfpages_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['bccf.BCCFPages']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'bccf.bccfpages': {
            'Meta': {'ordering': "('titles',)", 'object_name': 'BCCFPages'},
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['bccf.BCCFPages']"}),
        ...
        u'bccf.bccfparentpage': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'BCCFParentPage', '_ormbases': [u'bccf.BCCFPages']},
            u'bccfpages_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['bccf.BCCFPages']", 'unique': 'True', 'primary_key': 'True'}),
