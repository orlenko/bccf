...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BCCFChildPage.parent'
        db.add_column(u'bccf_bccfchildpage', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bccf.BCCFParentPage'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'BCCFChildPage.parent'
        db.delete_column(u'bccf_bccfchildpage', 'parent_id')
    ...
    models = {
        ...
        u'bccf.bccfchildpage': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bccf.BCCFParentPage']", 'null': 'True', 'blank': 'True'}),
