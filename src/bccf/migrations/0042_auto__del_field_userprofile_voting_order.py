...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'bccf_userprofile', 'voting_order',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='voting', null=True, to=orm['shop.Order'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'shop.order': {
            ...
            'payer_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
