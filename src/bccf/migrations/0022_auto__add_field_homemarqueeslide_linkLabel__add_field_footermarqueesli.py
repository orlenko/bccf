...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomeMarqueeSlide.linkLabel'
        db.add_column(u'bccf_homemarqueeslide', 'linkLabel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FooterMarqueeSlide.linkLabel'
        db.add_column(u'bccf_footermarqueeslide', 'linkLabel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomeMarqueeSlide.linkLabel'
        db.delete_column(u'bccf_homemarqueeslide', 'linkLabel')

        # Deleting field 'FooterMarqueeSlide.linkLabel'
        db.delete_column(u'bccf_footermarqueeslide', 'linkLabel')
