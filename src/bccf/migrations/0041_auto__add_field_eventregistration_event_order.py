...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bccf_eventregistration', 'event_order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='event-order', null=True, blank=True, to=orm['shop.Order']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventRegistration.event_order'
        db.delete_column(u'bccf_eventregistration', 'event_order_id')
