...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.in_mailing_list'
        db.add_column(u'bccf_userprofile', 'in_mailing_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.in_mailing_list'
        db.delete_column(u'bccf_userprofile', 'in_mailing_list')
