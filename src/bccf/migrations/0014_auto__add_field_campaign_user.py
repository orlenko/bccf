...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bccf_campaign', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='creator', null=True, to=orm['bccf.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.user'
        db.delete_column(u'bccf_campaign', 'user_id')
    ...
    models = {
        ...
        u'bccf.campaign': {
            ...
            u'bccfchildpage_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['bccf.BCCFChildPage']", 'unique': 'True', 'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'creator'", 'null': 'True', 'to': u"orm['bccf.UserProfile']"})
        },
