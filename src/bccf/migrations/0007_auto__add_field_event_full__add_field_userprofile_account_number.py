...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.full'
        db.add_column(u'bccf_event', 'full',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.account_number'
        db.add_column(u'bccf_userprofile', 'account_number',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.full'
        db.delete_column(u'bccf_event', 'full')

        # Deleting field 'UserProfile.account_number'
        db.delete_column(u'bccf_userprofile', 'account_number')
