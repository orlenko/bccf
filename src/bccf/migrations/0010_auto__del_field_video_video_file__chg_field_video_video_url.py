...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bccf_video', 'video_url', self.gf('embed_video.fields.EmbedVideoField')(max_length=1024, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Video.video_url'
        db.alter_column(u'bccf_video', 'video_url', self.gf('django.db.models.fields.URLField')(max_length=1024, null=True))
