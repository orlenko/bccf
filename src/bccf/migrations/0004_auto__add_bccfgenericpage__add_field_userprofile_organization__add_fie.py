...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bccf_userprofile', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bccf.UserProfile'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'BCCFChildPage.comments_count'
        db.add_column(u'bccf_bccfchildpage', 'comments_count',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'bccf_userprofile', 'organization_id')

        # Deleting field 'BCCFChildPage.comments_count'
        db.delete_column(u'bccf_bccfchildpage', 'comments_count')
