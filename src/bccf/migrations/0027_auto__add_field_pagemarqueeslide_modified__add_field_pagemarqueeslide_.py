...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageMarqueeSlide.modified'
        db.add_column(u'bccf_pagemarqueeslide', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 3, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PageMarqueeSlide.created'
        db.add_column(u'bccf_pagemarqueeslide', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 3, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PageMarquee.modified'
        db.add_column(u'bccf_pagemarquee', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 3, 0, 0), blank=True),
                      keep_default=False)
        ...
        # Adding field 'FooterMarquee.modified'
        db.add_column(u'bccf_footermarquee', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 3, 0, 0), blank=True),
                      keep_default=False)
        ...
        # Adding field 'FooterMarqueeSlide.modified'
        db.add_column(u'bccf_footermarqueeslide', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 3, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'FooterMarqueeSlide.created'
        db.add_column(u'bccf_footermarqueeslide', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 3, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'HomeMarquee.modified'
        db.add_column(u'bccf_homemarquee', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 3, 0, 0), blank=True),
                      keep_default=False)
        ...
        # Adding field 'HomeMarqueeSlide.modified'
        db.add_column(u'bccf_homemarqueeslide', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 3, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'HomeMarqueeSlide.created'
        db.add_column(u'bccf_homemarqueeslide', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 3, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageMarqueeSlide.modified'
        db.delete_column(u'bccf_pagemarqueeslide', 'modified')

        # Deleting field 'PageMarqueeSlide.created'
        db.delete_column(u'bccf_pagemarqueeslide', 'created')

        # Deleting field 'PageMarquee.modified'
        db.delete_column(u'bccf_pagemarquee', 'modified')

        # Deleting field 'PageMarquee.created'
        db.delete_column(u'bccf_pagemarquee', 'created')

        # Deleting field 'FooterMarquee.modified'
        db.delete_column(u'bccf_footermarquee', 'modified')

        # Deleting field 'FooterMarquee.created'
        db.delete_column(u'bccf_footermarquee', 'created')

        # Deleting field 'FooterMarqueeSlide.modified'
        db.delete_column(u'bccf_footermarqueeslide', 'modified')

        # Deleting field 'FooterMarqueeSlide.created'
        db.delete_column(u'bccf_footermarqueeslide', 'created')

        # Deleting field 'HomeMarquee.modified'
        db.delete_column(u'bccf_homemarquee', 'modified')

        # Deleting field 'HomeMarquee.created'
        db.delete_column(u'bccf_homemarquee', 'created')

        # Deleting field 'HomeMarqueeSlide.modified'
        db.delete_column(u'bccf_homemarqueeslide', 'modified')

        # Deleting field 'HomeMarqueeSlide.created'
        db.delete_column(u'bccf_homemarqueeslide', 'created')
