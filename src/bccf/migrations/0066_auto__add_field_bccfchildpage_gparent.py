...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BCCFChildPage.gparent'
        db.add_column(u'bccf_bccfchildpage', 'gparent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bccf.BCCFPage'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BCCFChildPage.gparent'
        db.delete_column(u'bccf_bccfchildpage', 'gparent_id')
