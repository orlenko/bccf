...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'TestPodCast'
        db.delete_table(u'bccf_testpodcast')

        # Adding model 'Audio'
        db.create_table(u'bccf_audio', (
            ...
            ('attached_audio', self.gf('mezzanine.core.fields.FileField')(max_length=1024, null=True, blank=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Product'], null=True, blank=True)),
        ))
        db.send_create_signal(u'bccf', ['Audio'])


    def backwards(self, orm):
        # Adding model 'TestPodCast'
        db.create_table(u'bccf_testpodcast', (
            ('attached_audio', self.gf('mezzanine.core.fields.FileField')(max_length=1024, null=True, blank=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Product'], null=True, blank=True)),
            (u'bccfchildpage_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bccf.BCCFChildPage'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'bccf', ['TestPodCast'])

        # Deleting model 'Audio'
        db.delete_table(u'bccf_audio')
    ...
    models = {
        ...
        u'bccf.audio': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Audio', '_ormbases': [u'bccf.BCCFChildPage']},
