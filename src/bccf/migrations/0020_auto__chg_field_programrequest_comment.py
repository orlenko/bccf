...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProgramRequest.comment'
        db.alter_column(u'bccf_programrequest', 'comment', self.gf('mezzanine.core.fields.RichTextField')(null=True))

    def backwards(self, orm):

        # Changing field 'ProgramRequest.comment'
        db.alter_column(u'bccf_programrequest', 'comment', self.gf('django.db.models.fields.TextField')(null=True))
