...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_in_list'
        db.add_column(u'bccf_userprofile', 'show_in_list',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_in_list'
        db.delete_column(u'bccf_userprofile', 'show_in_list')
