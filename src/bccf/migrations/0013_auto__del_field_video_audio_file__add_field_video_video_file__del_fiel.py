...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'bccf_topic', 'name')
        ...
        db.add_column(u'bccf_topic', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Test Topic', max_length=500),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'bccf_topic', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Test Topic', max_length=255),
                      keep_default=False)
