...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Program.bccfchildpage_ptr'
        db.delete_column(u'bccf_program', u'bccfchildpage_ptr_id')
        ...
        db.add_column(u'bccf_program', u'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Program.site'
        db.add_column(u'bccf_program', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'Program.title'
        db.add_column(u'bccf_program', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=500),
                      keep_default=False)

        # Adding field 'Program.slug'
        db.add_column(u'bccf_program', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Program._meta_title'
        db.add_column(u'bccf_program', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Program.description'
        db.add_column(u'bccf_program', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Program.gen_description'
        db.add_column(u'bccf_program', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Program.created'
        db.add_column(u'bccf_program', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Program.updated'
        db.add_column(u'bccf_program', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Program.status'
        db.add_column(u'bccf_program', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Program.publish_date'
        db.add_column(u'bccf_program', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Program.expiry_date'
        db.add_column(u'bccf_program', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Program.short_url'
        db.add_column(u'bccf_program', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Program.in_sitemap'
        db.add_column(u'bccf_program', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Program.content'
        db.add_column(u'bccf_program', 'content',
                      self.gf('mezzanine.core.fields.RichTextField')(default=1),
                      keep_default=False)

        # Adding field 'Program.marquee'
        db.add_column(u'bccf_program', 'marquee',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bccf.PageMarquee'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Program.carousel_color'
        db.add_column(u'bccf_program', 'carousel_color',
                      self.gf('django.db.models.fields.CharField')(default='dgreen-list', max_length=11),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Program.bccfchildpage_ptr'
        db.add_column(u'bccf_program', u'bccfchildpage_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['bccf.BCCFChildPage'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'Program.id'
        db.delete_column(u'bccf_program', u'id')

        # Deleting field 'Program.keywords_string'
        db.delete_column(u'bccf_program', u'keywords_string')

        # Deleting field 'Program.site'
        db.delete_column(u'bccf_program', 'site_id')

        # Deleting field 'Program.title'
        db.delete_column(u'bccf_program', 'title')

        # Deleting field 'Program.slug'
        db.delete_column(u'bccf_program', 'slug')

        # Deleting field 'Program._meta_title'
        db.delete_column(u'bccf_program', '_meta_title')

        # Deleting field 'Program.description'
        db.delete_column(u'bccf_program', 'description')

        # Deleting field 'Program.gen_description'
        db.delete_column(u'bccf_program', 'gen_description')

        # Deleting field 'Program.created'
        db.delete_column(u'bccf_program', 'created')

        # Deleting field 'Program.updated'
        db.delete_column(u'bccf_program', 'updated')

        # Deleting field 'Program.status'
        db.delete_column(u'bccf_program', 'status')

        # Deleting field 'Program.publish_date'
        db.delete_column(u'bccf_program', 'publish_date')

        # Deleting field 'Program.expiry_date'
        db.delete_column(u'bccf_program', 'expiry_date')

        # Deleting field 'Program.short_url'
        db.delete_column(u'bccf_program', 'short_url')

        # Deleting field 'Program.in_sitemap'
        db.delete_column(u'bccf_program', 'in_sitemap')

        # Deleting field 'Program.content'
        db.delete_column(u'bccf_program', 'content')

        # Deleting field 'Program.marquee'
        db.delete_column(u'bccf_program', 'marquee_id')

        # Deleting field 'Program.carousel_color'
        db.delete_column(u'bccf_program', 'carousel_color')
    ...
    models = {
        ...
        u'bccf.eventregistration': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'registree'", 'to': u"orm['auth.User']"})
        },
