...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.membership_order'
        db.add_column(u'bccf_userprofile', 'membership_order',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Order'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.membership_order'
        db.delete_column(u'bccf_userprofile', 'membership_order_id')
