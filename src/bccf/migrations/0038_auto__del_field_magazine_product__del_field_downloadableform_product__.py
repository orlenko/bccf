...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Magazine.product'
        db.delete_column(u'bccf_magazine', 'product_id')

        # Deleting field 'DownloadableForm.product'
        db.delete_column(u'bccf_downloadableform', 'product_id')

        # Deleting field 'Podcast.product'
        db.delete_column(u'bccf_podcast', 'product_id')

        # Deleting field 'Video.product'
        db.delete_column(u'bccf_video', 'product_id')

        # Deleting field 'TipSheet.product'
        db.delete_column(u'bccf_tipsheet', 'product_id')

        # Deleting field 'Article.product'
        db.delete_column(u'bccf_article', 'product_id')


    def backwards(self, orm):
        # Adding field 'Magazine.product'
        db.add_column(u'bccf_magazine', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Product'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'DownloadableForm.product'
        db.add_column(u'bccf_downloadableform', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Product'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Podcast.product'
        db.add_column(u'bccf_podcast', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Product'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.product'
        db.add_column(u'bccf_video', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Product'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'TipSheet.product'
        db.add_column(u'bccf_tipsheet', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Product'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.product'
        db.add_column(u'bccf_article', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Product'], null=True, blank=True),
                      keep_default=False)
