...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventForProfessionals.survey_before'
        db.add_column(u'bccf_eventforprofessionals', 'survey_before',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='survey_before', null=True, to=orm['builder.FormPublished']),
                      keep_default=False)

        # Adding field 'EventForProfessionals.survey_after'
        db.add_column(u'bccf_eventforprofessionals', 'survey_after',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='survey_after', null=True, to=orm['builder.FormPublished']),
                      keep_default=False)

        # Deleting field 'Video.audio_file'
        db.delete_column(u'bccf_video', 'audio_file')

        # Adding field 'Video.video_file'
        db.add_column(u'bccf_video', 'video_file',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventForProfessionals.survey_before'
        db.delete_column(u'bccf_eventforprofessionals', 'survey_before_id')

        # Deleting field 'EventForProfessionals.survey_after'
        db.delete_column(u'bccf_eventforprofessionals', 'survey_after_id')

        # Adding field 'Video.audio_file'
        db.add_column(u'bccf_video', 'audio_file',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Video.video_file'
        db.delete_column(u'bccf_video', 'video_file')
