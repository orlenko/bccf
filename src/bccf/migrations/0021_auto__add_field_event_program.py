...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bccf_event', 'program',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='program', null=True, to=orm['bccf.Program']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.program'
        db.delete_column(u'bccf_event', 'program_id')
