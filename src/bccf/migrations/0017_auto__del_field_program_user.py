...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'bccf_program', 'user_id')

        # Adding M2M table for field user on 'Program'
        m2m_table_name = db.shorten_name(u'bccf_program_user')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'bccf_program', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field user on 'Program'
        db.delete_table(db.shorten_name(u'bccf_program_user'))
