...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Page.marquee'
        db.alter_column(u'bccf_page', 'marquee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bccf.PageMarquee'], null=True))

    def backwards(self, orm):

        # Changing field 'Page.marquee'
        db.alter_column(u'bccf_page', 'marquee_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['bccf.PageMarquee']))
