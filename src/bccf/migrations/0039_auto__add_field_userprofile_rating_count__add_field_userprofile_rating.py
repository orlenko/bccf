...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.rating_count'
        db.add_column(u'bccf_userprofile', u'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserProfile.rating_sum'
        db.add_column(u'bccf_userprofile', u'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserProfile.rating_average'
        db.add_column(u'bccf_userprofile', u'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.rating_count'
        db.delete_column(u'bccf_userprofile', u'rating_count')

        # Deleting field 'UserProfile.rating_sum'
        db.delete_column(u'bccf_userprofile', u'rating_sum')

        # Deleting field 'UserProfile.rating_average'
        db.delete_column(u'bccf_userprofile', u'rating_average')
