...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.othersm'
        db.add_column(u'bccf_userprofile', 'othersm',
    ...
    def backwards(self, orm):
        # Deleting field 'UserProfile.othersm'
        db.delete_column(u'bccf_userprofile', 'othersm')
    ...
    models = {
        ...
        u'bccf.event': {
            ...
            'program': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'program'", 'null': 'True', 'to': u"orm['bccf.Program']"}),
        ...
        u'bccf.userprofile': {
            ...
            'othersm': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
