...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BCCFGenericPage.show_resources'
        db.add_column(u'bccf_bccfgenericpage', 'show_resources',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BCCFGenericPage.show_comments'
        db.add_column(u'bccf_bccfgenericpage', 'show_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BCCFGenericPage.show_resources'
        db.delete_column(u'bccf_bccfgenericpage', 'show_resources')

        # Deleting field 'BCCFGenericPage.show_comments'
        db.delete_column(u'bccf_bccfgenericpage', 'show_comments')
    ...
    models = {
        ...
        u'bccf.bccfgenericpage': {
            ...
            'show_resources': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'bccf.bccfpage': {
