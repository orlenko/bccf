...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BigMarqueeSlide.active'
        db.add_column(u'bccf_bigmarqueeslide', 'active',
    ...
    def backwards(self, orm):
        # Deleting field 'BigMarqueeSlide.active'
        db.delete_column(u'bccf_bigmarqueeslide', 'active')
