...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.voting_order'
        db.add_column(u'bccf_userprofile', 'voting_order',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='voting', null=True, to=orm['shop.Order']),
                      keep_default=False)

        # Adding field 'UserProfile.membership_level'
        db.add_column(u'bccf_userprofile', 'membership_level',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.voting_order'
        db.delete_column(u'bccf_userprofile', 'voting_order_id')

        # Deleting field 'UserProfile.membership_level'
        db.delete_column(u'bccf_userprofile', 'membership_level')
