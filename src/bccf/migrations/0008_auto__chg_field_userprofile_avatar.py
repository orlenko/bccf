...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bccf_userprofile', 'avatar', self.gf('bccf.fields.MyImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.avatar'
        db.alter_column(u'bccf_userprofile', 'avatar', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))
