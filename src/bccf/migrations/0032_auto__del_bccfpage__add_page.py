...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bccf_page', (
            ...
            ('marquee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bccf.PageMarquee'])),
        ))
    ...
    models = {
        ...
        u'bccf.page': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'Page', '_ormbases': [u'pages.Page']},
            'marquee': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bccf.PageMarquee']"}),
