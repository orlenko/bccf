...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BCCFGenericPage.show_rating'
        db.add_column(u'bccf_bccfgenericpage', 'show_rating',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BCCFGenericPage.show_rating'
        db.delete_column(u'bccf_bccfgenericpage', 'show_rating')
