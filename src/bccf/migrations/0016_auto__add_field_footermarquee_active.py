...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FooterMarquee.active'
        db.add_column(u'bccf_footermarquee', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FooterMarquee.active'
        db.delete_column(u'bccf_footermarquee', 'active')
