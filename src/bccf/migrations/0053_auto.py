...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field bccf_program on 'BCCFChildPage'
        m2m_table_name = db.shorten_name(u'bccf_bccfchildpage_bccf_program')
        ...
        db.create_unique(m2m_table_name, ['bccfchildpage_id', 'program_id'])


    def backwards(self, orm):
        # Removing M2M table for field bccf_program on 'BCCFChildPage'
        db.delete_table(db.shorten_name(u'bccf_bccfchildpage_bccf_program'))
    ...
    models = {
        ...
        u'bccf.bccfchildpage': {
            ...
            'bccf_program': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['bccf.Program']", 'null': 'True', 'blank': 'True'}),
