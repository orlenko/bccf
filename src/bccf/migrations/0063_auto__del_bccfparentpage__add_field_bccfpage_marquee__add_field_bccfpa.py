...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BCCFPage.carousel_color'
        db.add_column(u'bccf_bccfpage', 'carousel_color',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BCCFPage.carousel_color'
        db.delete_column(u'bccf_bccfpage', 'carousel_color')


        # Changing field 'BCCFChildPage.parent'
        db.alter_column(u'bccf_bccfchildpage', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bccf.BCCFParentPage'], null=True))
