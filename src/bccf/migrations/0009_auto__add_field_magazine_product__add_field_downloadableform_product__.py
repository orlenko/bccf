...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BCCFChildPage.image'
        db.alter_column(u'bccf_bccfchildpage', 'image', self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BCCFChildPage.image'
        db.alter_column(u'bccf_bccfchildpage', 'image', self.gf('bccf.fields.MyImageField')(max_length=255, null=True))
