...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Podcast.attached_audio'
        db.alter_column(u'bccf_podcast', 'attached_audio', self.gf('mezzanine.core.fields.FileField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'Podcast.attached_audio'
        db.alter_column(u'bccf_podcast', 'attached_audio', self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True))
