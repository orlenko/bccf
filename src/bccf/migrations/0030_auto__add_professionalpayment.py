...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProfessionalPayment'
        db.create_table(u'bccf_professionalpayment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='paid_to', to=orm['auth.User'])),
            ('amount', self.gf('cartridge.shop.fields.MoneyField')(null=True, max_digits=10, decimal_places=2, blank=True)),
            ('paid_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'bccf', ['ProfessionalPayment'])


    def backwards(self, orm):
        # Deleting model 'ProfessionalPayment'
        db.delete_table(u'bccf_professionalpayment')
    ...
    models = {
        ...
        u'bccf.professionalpayment': {
            'Meta': {'object_name': 'ProfessionalPayment'},
