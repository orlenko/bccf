...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.requested_cancellation'
        db.delete_column(u'bccf_userprofile', 'requested_cancellation')

        # Adding field 'UserProfile.requested_cancellations'
        db.add_column(u'bccf_userprofile', 'requested_cancellations',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.requested_cancellation'
        db.add_column(u'bccf_userprofile', 'requested_cancellation',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.requested_cancellations'
        db.delete_column(u'bccf_userprofile', 'requested_cancellations')
    ...
    models = {
        ...
        u'bccf.userprofile': {
            ...
            'requested_cancellations': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
