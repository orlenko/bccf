...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PageMarqueeSlide.active'
        db.delete_column(u'bccf_pagemarqueeslide', 'active')

        # Removing M2M table for field marquee on 'PageMarqueeSlide'
        db.delete_table(db.shorten_name(u'bccf_pagemarqueeslide_marquee'))

        # Adding M2M table for field slides on 'FooterMarquee'
        m2m_table_name = db.shorten_name(u'bccf_footermarquee_slides')
        ...
        db.create_unique(m2m_table_name, ['footermarquee_id', 'footermarqueeslide_id'])

        # Deleting field 'FooterMarqueeSlide.active'
        db.delete_column(u'bccf_footermarqueeslide', 'active')
        ...
        # Adding M2M table for field slides on 'HomeMarquee'
        m2m_table_name = db.shorten_name(u'bccf_homemarquee_slides')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique(m2m_table_name, ['homemarquee_id', 'homemarqueeslide_id'])

        # Deleting field 'HomeMarqueeSlide.active'
        db.delete_column(u'bccf_homemarqueeslide', 'active')
    ...
    def backwards(self, orm):
        # Adding field 'PageMarqueeSlide.active'
        db.add_column(u'bccf_pagemarqueeslide', 'active',
        ...
        # Removing M2M table for field slides on 'FooterMarquee'
        db.delete_table(db.shorten_name(u'bccf_footermarquee_slides'))

        # Adding field 'FooterMarqueeSlide.active'
        db.add_column(u'bccf_footermarqueeslide', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        # Removing M2M table for field slides on 'HomeMarquee'
        db.delete_table(db.shorten_name(u'bccf_homemarquee_slides'))

        # Adding field 'HomeMarqueeSlide.active'
        db.add_column(u'bccf_homemarqueeslide', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'bccf.footermarquee': {
            ...
            'slides': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['bccf.FooterMarqueeSlide']", 'symmetrical': 'False'}),
        ...
        u'bccf.homemarquee': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'slides': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['bccf.HomeMarqueeSlide']", 'symmetrical': 'False'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
