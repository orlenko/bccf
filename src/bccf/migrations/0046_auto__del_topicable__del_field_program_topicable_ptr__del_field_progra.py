...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Topicable'
        db.delete_table(u'bccf_topicable')

        # Removing M2M table for field topics on 'Topicable'
        db.delete_table(db.shorten_name(u'bccf_topicable_topics'))

        # Deleting field 'Program.topicable_ptr'
        db.delete_column(u'bccf_program', u'topicable_ptr_id')

        # Deleting field 'ProgramChild.topicable_ptr'
        db.delete_column(u'bccf_programchild', u'topicable_ptr_id')


    def backwards(self, orm):
        # Adding model 'Topicable'
        db.create_table(u'bccf_topicable', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'bccf', ['Topicable'])

        # Adding M2M table for field topics on 'Topicable'
        m2m_table_name = db.shorten_name(u'bccf_topicable_topics')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('topicable', models.ForeignKey(orm[u'bccf.topicable'], null=False)),
            ('topic', models.ForeignKey(orm[u'bccf.topic'], null=False))
        ))
        db.create_unique(m2m_table_name, ['topicable_id', 'topic_id'])

        # Adding field 'Program.topicable_ptr'
        db.add_column(u'bccf_program', u'topicable_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['bccf.Topicable'], unique=True),
                      keep_default=False)

        # Adding field 'ProgramChild.topicable_ptr'
        db.add_column(u'bccf_programchild', u'topicable_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['bccf.Topicable'], unique=True),
                      keep_default=False)
