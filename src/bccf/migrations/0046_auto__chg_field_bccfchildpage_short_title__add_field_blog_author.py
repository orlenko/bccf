...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BCCFChildPage.short_title'
        db.alter_column(u'bccf_bccfchildpage', 'short_title', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
        # Adding field 'Blog.author'
        db.add_column(u'bccf_blog', 'author',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BCCFChildPage.short_title'
        db.alter_column(u'bccf_bccfchildpage', 'short_title', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
        # Deleting field 'Blog.author'
        db.delete_column(u'bccf_blog', 'author_id')
