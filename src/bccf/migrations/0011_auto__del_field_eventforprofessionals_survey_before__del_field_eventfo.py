...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'bccf_eventforprofessionals', 'survey_before',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='survey_before', null=True, to=orm['builder.FormPublished'], blank=True),
                      keep_default=False)

        # Adding field 'EventForProfessionals.survey_after'
        db.add_column(u'bccf_eventforprofessionals', 'survey_after',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='survey_after', null=True, to=orm['builder.FormPublished'], blank=True),
                      keep_default=False)
