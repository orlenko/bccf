...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventRegistration.reminder'
        db.add_column(u'bccf_eventregistration', 'reminder',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventRegistration.reminder'
        db.delete_column(u'bccf_eventregistration', 'reminder')
