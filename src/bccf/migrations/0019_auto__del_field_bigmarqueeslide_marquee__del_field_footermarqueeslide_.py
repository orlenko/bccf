...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BigMarqueeSlide.marquee'
        db.delete_column(u'bccf_bigmarqueeslide', 'marquee_id')

        # Adding M2M table for field marquee on 'BigMarqueeSlide'
        m2m_table_name = db.shorten_name(u'bccf_bigmarqueeslide_marquee')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bigmarqueeslide', models.ForeignKey(orm[u'bccf.bigmarqueeslide'], null=False)),
            ('bigmarquee', models.ForeignKey(orm[u'bccf.bigmarquee'], null=False))
        ))
        db.create_unique(m2m_table_name, ['bigmarqueeslide_id', 'bigmarquee_id'])

        # Deleting field 'FooterMarqueeSlide.marquee'
        db.delete_column(u'bccf_footermarqueeslide', 'marquee_id')
    ...
    def backwards(self, orm):
        # Adding field 'BigMarqueeSlide.marquee'
        db.add_column(u'bccf_bigmarqueeslide', 'marquee',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['bccf.BigMarquee']),
                      keep_default=False)

        # Removing M2M table for field marquee on 'BigMarqueeSlide'
        db.delete_table(db.shorten_name(u'bccf_bigmarqueeslide_marquee'))

        # Adding field 'FooterMarqueeSlide.marquee'
        db.add_column(u'bccf_footermarqueeslide', 'marquee',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['bccf.FooterMarquee']),
                      keep_default=False)
    ...
    models = {
        ...
        u'bccf.bigmarqueeslide': {
            ...
            'marquee': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['bccf.BigMarquee']", 'symmetrical': 'False'}),
