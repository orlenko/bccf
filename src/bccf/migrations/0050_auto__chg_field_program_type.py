...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Program.type'
        db.alter_column(u'bccf_program', 'type', self.gf('django.db.models.fields.CharField')(max_length=13, null=True))

    def backwards(self, orm):

        # Changing field 'Program.type'
        db.alter_column(u'bccf_program', 'type', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'bccf.program': {
            ...
            'image': ('mezzanine.core.fields.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'Parents'", 'max_length': '13', 'null': 'True', 'blank': 'True'})
        },
        u'bccf.programchild': {
