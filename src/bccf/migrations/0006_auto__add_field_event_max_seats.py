...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.max_seats'
        db.add_column(u'bccf_event', 'max_seats',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.max_seats'
        db.delete_column(u'bccf_event', 'max_seats')
    ...
    models = {
        ...
        u'bccf.event': {
            ...
            'max_seats': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
