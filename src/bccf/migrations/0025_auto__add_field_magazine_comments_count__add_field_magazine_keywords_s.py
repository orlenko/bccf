...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Magazine.comments_count'
        db.add_column(u'bccf_magazine', 'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Magazine.keywords_string'
        db.add_column(u'bccf_magazine', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Magazine.rating_count'
        db.add_column(u'bccf_magazine', 'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Magazine.rating_sum'
        db.add_column(u'bccf_magazine', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Magazine.rating_average'
        db.add_column(u'bccf_magazine', 'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Event.comments_count'
        db.add_column(u'bccf_event', 'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Event.keywords_string'
        db.add_column(u'bccf_event', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Event.rating_count'
        db.add_column(u'bccf_event', 'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Event.rating_sum'
        db.add_column(u'bccf_event', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Event.rating_average'
        db.add_column(u'bccf_event', 'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Campaign.comments_count'
        db.add_column(u'bccf_campaign', 'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Campaign.keywords_string'
        db.add_column(u'bccf_campaign', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Campaign.rating_count'
        db.add_column(u'bccf_campaign', 'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Campaign.rating_sum'
        db.add_column(u'bccf_campaign', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Campaign.rating_average'
        db.add_column(u'bccf_campaign', 'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
        ...
        # Adding field 'DownloadableForm.comments_count'
        db.add_column(u'bccf_downloadableform', 'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DownloadableForm.keywords_string'
        db.add_column(u'bccf_downloadableform', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'DownloadableForm.rating_count'
        db.add_column(u'bccf_downloadableform', 'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DownloadableForm.rating_sum'
        db.add_column(u'bccf_downloadableform', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DownloadableForm.rating_average'
        db.add_column(u'bccf_downloadableform', 'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Podcast.comments_count'
        db.add_column(u'bccf_podcast', 'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Podcast.keywords_string'
        db.add_column(u'bccf_podcast', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Podcast.rating_count'
        db.add_column(u'bccf_podcast', 'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Podcast.rating_sum'
        db.add_column(u'bccf_podcast', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Podcast.rating_average'
        db.add_column(u'bccf_podcast', 'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'BCCFBabyPage.comments_count'
        db.add_column(u'bccf_bccfbabypage', 'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BCCFBabyPage.keywords_string'
        db.add_column(u'bccf_bccfbabypage', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'BCCFBabyPage.rating_count'
        db.add_column(u'bccf_bccfbabypage', 'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BCCFBabyPage.rating_sum'
        db.add_column(u'bccf_bccfbabypage', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BCCFBabyPage.rating_average'
        db.add_column(u'bccf_bccfbabypage', 'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Blog.comments_count'
        db.add_column(u'bccf_blog', 'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Blog.keywords_string'
        db.add_column(u'bccf_blog', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Blog.rating_count'
        db.add_column(u'bccf_blog', 'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Blog.rating_sum'
        db.add_column(u'bccf_blog', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Blog.rating_average'
        db.add_column(u'bccf_blog', 'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Program.comments_count'
        db.add_column(u'bccf_program', 'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Program.keywords_string'
        db.add_column(u'bccf_program', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Program.rating_count'
        db.add_column(u'bccf_program', 'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Program.rating_sum'
        db.add_column(u'bccf_program', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Program.rating_average'
        db.add_column(u'bccf_program', 'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Video.comments_count'
        db.add_column(u'bccf_video', 'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Video.keywords_string'
        db.add_column(u'bccf_video', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Video.rating_count'
        db.add_column(u'bccf_video', 'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Video.rating_sum'
        db.add_column(u'bccf_video', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Video.rating_average'
        db.add_column(u'bccf_video', 'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'TipSheet.comments_count'
        db.add_column(u'bccf_tipsheet', 'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TipSheet.keywords_string'
        db.add_column(u'bccf_tipsheet', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'TipSheet.rating_count'
        db.add_column(u'bccf_tipsheet', 'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TipSheet.rating_sum'
        db.add_column(u'bccf_tipsheet', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TipSheet.rating_average'
        db.add_column(u'bccf_tipsheet', 'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'BCCFGenericPage.comments_count'
        db.add_column(u'bccf_bccfgenericpage', 'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BCCFGenericPage.keywords_string'
        db.add_column(u'bccf_bccfgenericpage', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'BCCFGenericPage.rating_count'
        db.add_column(u'bccf_bccfgenericpage', 'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BCCFGenericPage.rating_sum'
        db.add_column(u'bccf_bccfgenericpage', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BCCFGenericPage.rating_average'
        db.add_column(u'bccf_bccfgenericpage', 'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Article.comments_count'
        db.add_column(u'bccf_article', 'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Article.keywords_string'
        db.add_column(u'bccf_article', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Article.rating_count'
        db.add_column(u'bccf_article', 'rating_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Article.rating_sum'
        db.add_column(u'bccf_article', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Article.rating_average'
        db.add_column(u'bccf_article', 'rating_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Magazine.comments_count'
        db.delete_column(u'bccf_magazine', 'comments_count')

        # Deleting field 'Magazine.keywords_string'
        db.delete_column(u'bccf_magazine', 'keywords_string')

        # Deleting field 'Magazine.rating_count'
        db.delete_column(u'bccf_magazine', 'rating_count')

        # Deleting field 'Magazine.rating_sum'
        db.delete_column(u'bccf_magazine', 'rating_sum')

        # Deleting field 'Magazine.rating_average'
        db.delete_column(u'bccf_magazine', 'rating_average')

        # Deleting field 'Event.comments_count'
        db.delete_column(u'bccf_event', 'comments_count')

        # Deleting field 'Event.keywords_string'
        db.delete_column(u'bccf_event', 'keywords_string')

        # Deleting field 'Event.rating_count'
        db.delete_column(u'bccf_event', 'rating_count')

        # Deleting field 'Event.rating_sum'
        db.delete_column(u'bccf_event', 'rating_sum')

        # Deleting field 'Event.rating_average'
        db.delete_column(u'bccf_event', 'rating_average')

        # Deleting field 'Campaign.comments_count'
        db.delete_column(u'bccf_campaign', 'comments_count')

        # Deleting field 'Campaign.keywords_string'
        db.delete_column(u'bccf_campaign', 'keywords_string')

        # Deleting field 'Campaign.rating_count'
        db.delete_column(u'bccf_campaign', 'rating_count')

        # Deleting field 'Campaign.rating_sum'
        db.delete_column(u'bccf_campaign', 'rating_sum')

        # Deleting field 'Campaign.rating_average'
        db.delete_column(u'bccf_campaign', 'rating_average')

        # Deleting field 'BCCFPage.keywords_string'
        db.delete_column(u'bccf_bccfpage', 'keywords_string')

        # Deleting field 'DownloadableForm.comments_count'
        db.delete_column(u'bccf_downloadableform', 'comments_count')

        # Deleting field 'DownloadableForm.keywords_string'
        db.delete_column(u'bccf_downloadableform', 'keywords_string')

        # Deleting field 'DownloadableForm.rating_count'
        db.delete_column(u'bccf_downloadableform', 'rating_count')

        # Deleting field 'DownloadableForm.rating_sum'
        db.delete_column(u'bccf_downloadableform', 'rating_sum')

        # Deleting field 'DownloadableForm.rating_average'
        db.delete_column(u'bccf_downloadableform', 'rating_average')

        # Deleting field 'Podcast.comments_count'
        db.delete_column(u'bccf_podcast', 'comments_count')

        # Deleting field 'Podcast.keywords_string'
        db.delete_column(u'bccf_podcast', 'keywords_string')

        # Deleting field 'Podcast.rating_count'
        db.delete_column(u'bccf_podcast', 'rating_count')

        # Deleting field 'Podcast.rating_sum'
        db.delete_column(u'bccf_podcast', 'rating_sum')

        # Deleting field 'Podcast.rating_average'
        db.delete_column(u'bccf_podcast', 'rating_average')

        # Deleting field 'BCCFBabyPage.comments_count'
        db.delete_column(u'bccf_bccfbabypage', 'comments_count')

        # Deleting field 'BCCFBabyPage.keywords_string'
        db.delete_column(u'bccf_bccfbabypage', 'keywords_string')

        # Deleting field 'BCCFBabyPage.rating_count'
        db.delete_column(u'bccf_bccfbabypage', 'rating_count')

        # Deleting field 'BCCFBabyPage.rating_sum'
        db.delete_column(u'bccf_bccfbabypage', 'rating_sum')

        # Deleting field 'BCCFBabyPage.rating_average'
        db.delete_column(u'bccf_bccfbabypage', 'rating_average')

        # Deleting field 'Blog.comments_count'
        db.delete_column(u'bccf_blog', 'comments_count')

        # Deleting field 'Blog.keywords_string'
        db.delete_column(u'bccf_blog', 'keywords_string')

        # Deleting field 'Blog.rating_count'
        db.delete_column(u'bccf_blog', 'rating_count')

        # Deleting field 'Blog.rating_sum'
        db.delete_column(u'bccf_blog', 'rating_sum')

        # Deleting field 'Blog.rating_average'
        db.delete_column(u'bccf_blog', 'rating_average')

        # Deleting field 'Program.comments_count'
        db.delete_column(u'bccf_program', 'comments_count')

        # Deleting field 'Program.keywords_string'
        db.delete_column(u'bccf_program', 'keywords_string')

        # Deleting field 'Program.rating_count'
        db.delete_column(u'bccf_program', 'rating_count')

        # Deleting field 'Program.rating_sum'
        db.delete_column(u'bccf_program', 'rating_sum')

        # Deleting field 'Program.rating_average'
        db.delete_column(u'bccf_program', 'rating_average')

        # Deleting field 'Video.comments_count'
        db.delete_column(u'bccf_video', 'comments_count')

        # Deleting field 'Video.keywords_string'
        db.delete_column(u'bccf_video', 'keywords_string')

        # Deleting field 'Video.rating_count'
        db.delete_column(u'bccf_video', 'rating_count')

        # Deleting field 'Video.rating_sum'
        db.delete_column(u'bccf_video', 'rating_sum')

        # Deleting field 'Video.rating_average'
        db.delete_column(u'bccf_video', 'rating_average')

        # Deleting field 'TipSheet.comments_count'
        db.delete_column(u'bccf_tipsheet', 'comments_count')

        # Deleting field 'TipSheet.keywords_string'
        db.delete_column(u'bccf_tipsheet', 'keywords_string')

        # Deleting field 'TipSheet.rating_count'
        db.delete_column(u'bccf_tipsheet', 'rating_count')

        # Deleting field 'TipSheet.rating_sum'
        db.delete_column(u'bccf_tipsheet', 'rating_sum')

        # Deleting field 'TipSheet.rating_average'
        db.delete_column(u'bccf_tipsheet', 'rating_average')

        # Deleting field 'BCCFGenericPage.comments_count'
        db.delete_column(u'bccf_bccfgenericpage', 'comments_count')

        # Deleting field 'BCCFGenericPage.keywords_string'
        db.delete_column(u'bccf_bccfgenericpage', 'keywords_string')

        # Deleting field 'BCCFGenericPage.rating_count'
        db.delete_column(u'bccf_bccfgenericpage', 'rating_count')

        # Deleting field 'BCCFGenericPage.rating_sum'
        db.delete_column(u'bccf_bccfgenericpage', 'rating_sum')

        # Deleting field 'BCCFGenericPage.rating_average'
        db.delete_column(u'bccf_bccfgenericpage', 'rating_average')

        # Deleting field 'Article.comments_count'
        db.delete_column(u'bccf_article', 'comments_count')

        # Deleting field 'Article.keywords_string'
        db.delete_column(u'bccf_article', 'keywords_string')

        # Deleting field 'Article.rating_count'
        db.delete_column(u'bccf_article', 'rating_count')

        # Deleting field 'Article.rating_sum'
        db.delete_column(u'bccf_article', 'rating_sum')

        # Deleting field 'Article.rating_average'
        db.delete_column(u'bccf_article', 'rating_average')
    ...
    models = {
        ...
        u'bccf.campaign': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'Campaign'},
        ...
        u'bccf.eventregistration': {
            ...
            'event_order': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'event-order'", 'null': 'True', 'to': u"orm['shop.Order']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'bccf.podcast': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'Podcast', '_ormbases': [u'bccf.BCCFChildPage']},
        ...
        u'bccf.userprofile': {
            ...
            'voting_order': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'voting'", 'null': 'True', 'to': u"orm['shop.Order']"}),
        ...
        u'builder.formpublished': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'FormPublished'},
            u'bccfchildpage_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['bccf.BCCFChildPage']", 'unique': 'True', 'primary_key': 'True'}),
