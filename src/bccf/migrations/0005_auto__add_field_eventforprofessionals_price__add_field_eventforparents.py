...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventForProfessionals.price'
        db.add_column(u'bccf_eventforprofessionals', 'price',
                      self.gf('cartridge.shop.fields.MoneyField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'EventForParents.price'
        db.add_column(u'bccf_eventforparents', 'price',
                      self.gf('cartridge.shop.fields.MoneyField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventForProfessionals.price'
        db.delete_column(u'bccf_eventforprofessionals', 'price')

        # Deleting field 'EventForParents.price'
        db.delete_column(u'bccf_eventforparents', 'price')
