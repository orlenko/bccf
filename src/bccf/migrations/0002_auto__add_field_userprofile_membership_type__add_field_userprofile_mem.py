...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.membership_type'
        db.add_column(u'bccf_userprofile', 'membership_type',
    ...
    def backwards(self, orm):
        # Deleting field 'UserProfile.membership_type'
        db.delete_column(u'bccf_userprofile', 'membership_type')
