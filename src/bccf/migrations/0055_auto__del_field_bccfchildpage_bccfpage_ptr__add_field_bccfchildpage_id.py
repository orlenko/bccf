...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BCCFChildPage.bccfpage_ptr'
        db.delete_column(u'bccf_bccfchildpage', u'bccfpage_ptr_id')

        # Adding field 'BCCFChildPage.id'
        db.add_column(u'bccf_bccfchildpage', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Adding field 'BCCFChildPage.keywords_string'
        db.add_column(u'bccf_bccfchildpage', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'BCCFChildPage.site'
        db.add_column(u'bccf_bccfchildpage', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'BCCFChildPage.title'
        db.add_column(u'bccf_bccfchildpage', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=500),
                      keep_default=False)

        # Adding field 'BCCFChildPage.slug'
        db.add_column(u'bccf_bccfchildpage', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BCCFChildPage._meta_title'
        db.add_column(u'bccf_bccfchildpage', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BCCFChildPage.description'
        db.add_column(u'bccf_bccfchildpage', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'BCCFChildPage.gen_description'
        db.add_column(u'bccf_bccfchildpage', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'BCCFChildPage.created'
        db.add_column(u'bccf_bccfchildpage', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'BCCFChildPage.updated'
        db.add_column(u'bccf_bccfchildpage', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'BCCFChildPage.status'
        db.add_column(u'bccf_bccfchildpage', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'BCCFChildPage.publish_date'
        db.add_column(u'bccf_bccfchildpage', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BCCFChildPage.expiry_date'
        db.add_column(u'bccf_bccfchildpage', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BCCFChildPage.short_url'
        db.add_column(u'bccf_bccfchildpage', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BCCFChildPage.in_sitemap'
        db.add_column(u'bccf_bccfchildpage', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'BCCFChildPage.content'
        db.add_column(u'bccf_bccfchildpage', 'content',
                      self.gf('mezzanine.core.fields.RichTextField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BCCFChildPage.bccfpage_ptr'
        db.add_column(u'bccf_bccfchildpage', u'bccfpage_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['bccf.BCCFPage'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'BCCFChildPage.id'
        db.delete_column(u'bccf_bccfchildpage', u'id')

        # Deleting field 'BCCFChildPage.keywords_string'
        db.delete_column(u'bccf_bccfchildpage', 'keywords_string')

        # Deleting field 'BCCFChildPage.site'
        db.delete_column(u'bccf_bccfchildpage', 'site_id')

        # Deleting field 'BCCFChildPage.title'
        db.delete_column(u'bccf_bccfchildpage', 'title')

        # Deleting field 'BCCFChildPage.slug'
        db.delete_column(u'bccf_bccfchildpage', 'slug')

        # Deleting field 'BCCFChildPage._meta_title'
        db.delete_column(u'bccf_bccfchildpage', '_meta_title')

        # Deleting field 'BCCFChildPage.description'
        db.delete_column(u'bccf_bccfchildpage', 'description')

        # Deleting field 'BCCFChildPage.gen_description'
        db.delete_column(u'bccf_bccfchildpage', 'gen_description')

        # Deleting field 'BCCFChildPage.created'
        db.delete_column(u'bccf_bccfchildpage', 'created')

        # Deleting field 'BCCFChildPage.updated'
        db.delete_column(u'bccf_bccfchildpage', 'updated')

        # Deleting field 'BCCFChildPage.status'
        db.delete_column(u'bccf_bccfchildpage', 'status')

        # Deleting field 'BCCFChildPage.publish_date'
        db.delete_column(u'bccf_bccfchildpage', 'publish_date')

        # Deleting field 'BCCFChildPage.expiry_date'
        db.delete_column(u'bccf_bccfchildpage', 'expiry_date')

        # Deleting field 'BCCFChildPage.short_url'
        db.delete_column(u'bccf_bccfchildpage', 'short_url')

        # Deleting field 'BCCFChildPage.in_sitemap'
        db.delete_column(u'bccf_bccfchildpage', 'in_sitemap')

        # Deleting field 'BCCFChildPage.content'
        db.delete_column(u'bccf_bccfchildpage', 'content')
    ...
    models = {
        ...
        u'bccf.topic': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'Topic', '_ormbases': [u'bccf.BCCFParentPage']},
