...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.approve'
        db.add_column(u'bccf_campaign', 'approve',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Campaign.by_user'
        db.add_column(u'bccf_campaign', 'by_user',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.approve'
        db.delete_column(u'bccf_campaign', 'approve')

        # Deleting field 'Campaign.by_user'
        db.delete_column(u'bccf_campaign', 'by_user')
