...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Podcast.bccfchildpage_ptr'
        db.delete_column(u'bccf_podcast', u'bccfchildpage_ptr_id')

        # Adding field 'Podcast.id'
        db.add_column(u'bccf_podcast', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Podcast.bccfchildpage_ptr'
        db.add_column(u'bccf_podcast', u'bccfchildpage_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['bccf.BCCFChildPage'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'Podcast.id'
        db.delete_column(u'bccf_podcast', u'id')
