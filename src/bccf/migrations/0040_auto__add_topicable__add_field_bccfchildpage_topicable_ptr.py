...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BCCFChildPage.topicable_ptr'
        db.add_column(u'bccf_bccfchildpage', u'topicable_ptr',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BCCFChildPage.topicable_ptr'
        db.delete_column(u'bccf_bccfchildpage', u'topicable_ptr_id')
