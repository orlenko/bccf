...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field bccf_topic on 'Program'
        m2m_table_name = db.shorten_name(u'bccf_program_bccf_topic')
        ...
        db.create_unique(m2m_table_name, ['program_id', 'bccftopic_id'])


    def backwards(self, orm):
        # Removing M2M table for field bccf_topic on 'Program'
        db.delete_table(db.shorten_name(u'bccf_program_bccf_topic'))
