...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventForProfessionals.short_url'
        db.delete_column(u'bccf_eventforprofessionals', 'short_url')

        # Deleting field 'EventForProfessionals.site'
        db.delete_column(u'bccf_eventforprofessionals', 'site_id')

        # Deleting field 'EventForProfessionals.keywords_string'
        db.delete_column(u'bccf_eventforprofessionals', 'keywords_string')

        # Deleting field 'EventForProfessionals.in_sitemap'
        db.delete_column(u'bccf_eventforprofessionals', 'in_sitemap')

        # Deleting field 'EventForProfessionals.id'
        db.delete_column(u'bccf_eventforprofessionals', u'id')

        # Deleting field 'EventForProfessionals.title'
        db.delete_column(u'bccf_eventforprofessionals', 'title')

        # Deleting field 'EventForProfessionals.content'
        db.delete_column(u'bccf_eventforprofessionals', 'content')

        # Deleting field 'EventForProfessionals.status'
        db.delete_column(u'bccf_eventforprofessionals', 'status')

        # Deleting field 'EventForProfessionals.updated'
        db.delete_column(u'bccf_eventforprofessionals', 'updated')

        # Deleting field 'EventForProfessionals.description'
        db.delete_column(u'bccf_eventforprofessionals', 'description')

        # Deleting field 'EventForProfessionals.expiry_date'
        db.delete_column(u'bccf_eventforprofessionals', 'expiry_date')

        # Deleting field 'EventForProfessionals.slug'
        db.delete_column(u'bccf_eventforprofessionals', 'slug')

        # Deleting field 'EventForProfessionals.gen_description'
        db.delete_column(u'bccf_eventforprofessionals', 'gen_description')

        # Deleting field 'EventForProfessionals.created'
        db.delete_column(u'bccf_eventforprofessionals', 'created')

        # Deleting field 'EventForProfessionals._meta_title'
        db.delete_column(u'bccf_eventforprofessionals', '_meta_title')

        # Deleting field 'EventForProfessionals.publish_date'
        db.delete_column(u'bccf_eventforprofessionals', 'publish_date')

        # Adding field 'EventForProfessionals.bccfchildpage_ptr'
        db.add_column(u'bccf_eventforprofessionals', u'bccfchildpage_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['bccf.BCCFChildPage'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'EventForParents.short_url'
        db.delete_column(u'bccf_eventforparents', 'short_url')

        # Deleting field 'EventForParents.site'
        db.delete_column(u'bccf_eventforparents', 'site_id')

        # Deleting field 'EventForParents.keywords_string'
        db.delete_column(u'bccf_eventforparents', 'keywords_string')

        # Deleting field 'EventForParents.in_sitemap'
        db.delete_column(u'bccf_eventforparents', 'in_sitemap')

        # Deleting field 'EventForParents.id'
        db.delete_column(u'bccf_eventforparents', u'id')

        # Deleting field 'EventForParents.title'
        db.delete_column(u'bccf_eventforparents', 'title')

        # Deleting field 'EventForParents.content'
        db.delete_column(u'bccf_eventforparents', 'content')

        # Deleting field 'EventForParents.status'
        db.delete_column(u'bccf_eventforparents', 'status')

        # Deleting field 'EventForParents.updated'
        db.delete_column(u'bccf_eventforparents', 'updated')

        # Deleting field 'EventForParents.description'
        db.delete_column(u'bccf_eventforparents', 'description')

        # Deleting field 'EventForParents.expiry_date'
        db.delete_column(u'bccf_eventforparents', 'expiry_date')

        # Deleting field 'EventForParents.slug'
        db.delete_column(u'bccf_eventforparents', 'slug')

        # Deleting field 'EventForParents.gen_description'
        db.delete_column(u'bccf_eventforparents', 'gen_description')

        # Deleting field 'EventForParents.created'
        db.delete_column(u'bccf_eventforparents', 'created')

        # Deleting field 'EventForParents._meta_title'
        db.delete_column(u'bccf_eventforparents', '_meta_title')

        # Deleting field 'EventForParents.publish_date'
        db.delete_column(u'bccf_eventforparents', 'publish_date')

        # Adding field 'EventForParents.bccfchildpage_ptr'
        db.add_column(u'bccf_eventforparents', u'bccfchildpage_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['bccf.BCCFChildPage'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EventForProfessionals.short_url'
        db.add_column(u'bccf_eventforprofessionals', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventForProfessionals.site'
        db.add_column(u'bccf_eventforprofessionals', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'EventForProfessionals.keywords_string'
        db.add_column(u'bccf_eventforprofessionals', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'EventForProfessionals.in_sitemap'
        db.add_column(u'bccf_eventforprofessionals', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'EventForProfessionals.id'
        db.add_column(u'bccf_eventforprofessionals', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Adding field 'EventForProfessionals.title'
        db.add_column(u'bccf_eventforprofessionals', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=500),
                      keep_default=False)

        # Adding field 'EventForProfessionals.content'
        db.add_column(u'bccf_eventforprofessionals', 'content',
                      self.gf('mezzanine.core.fields.RichTextField')(default=1),
                      keep_default=False)

        # Adding field 'EventForProfessionals.status'
        db.add_column(u'bccf_eventforprofessionals', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'EventForProfessionals.updated'
        db.add_column(u'bccf_eventforprofessionals', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'EventForProfessionals.description'
        db.add_column(u'bccf_eventforprofessionals', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'EventForProfessionals.expiry_date'
        db.add_column(u'bccf_eventforprofessionals', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventForProfessionals.slug'
        db.add_column(u'bccf_eventforprofessionals', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventForProfessionals.gen_description'
        db.add_column(u'bccf_eventforprofessionals', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'EventForProfessionals.created'
        db.add_column(u'bccf_eventforprofessionals', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'EventForProfessionals._meta_title'
        db.add_column(u'bccf_eventforprofessionals', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventForProfessionals.publish_date'
        db.add_column(u'bccf_eventforprofessionals', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EventForProfessionals.bccfchildpage_ptr'
        db.delete_column(u'bccf_eventforprofessionals', u'bccfchildpage_ptr_id')

        # Adding field 'EventForParents.short_url'
        db.add_column(u'bccf_eventforparents', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventForParents.site'
        db.add_column(u'bccf_eventforparents', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'EventForParents.keywords_string'
        db.add_column(u'bccf_eventforparents', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'EventForParents.in_sitemap'
        db.add_column(u'bccf_eventforparents', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'EventForParents.id'
        db.add_column(u'bccf_eventforparents', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Adding field 'EventForParents.title'
        db.add_column(u'bccf_eventforparents', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=500),
                      keep_default=False)

        # Adding field 'EventForParents.content'
        db.add_column(u'bccf_eventforparents', 'content',
                      self.gf('mezzanine.core.fields.RichTextField')(default=1),
                      keep_default=False)

        # Adding field 'EventForParents.status'
        db.add_column(u'bccf_eventforparents', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'EventForParents.updated'
        db.add_column(u'bccf_eventforparents', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'EventForParents.description'
        db.add_column(u'bccf_eventforparents', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'EventForParents.expiry_date'
        db.add_column(u'bccf_eventforparents', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventForParents.slug'
        db.add_column(u'bccf_eventforparents', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventForParents.gen_description'
        db.add_column(u'bccf_eventforparents', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'EventForParents.created'
        db.add_column(u'bccf_eventforparents', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'EventForParents._meta_title'
        db.add_column(u'bccf_eventforparents', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventForParents.publish_date'
        db.add_column(u'bccf_eventforparents', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EventForParents.bccfchildpage_ptr'
        db.delete_column(u'bccf_eventforparents', u'bccfchildpage_ptr_id')
    ...
    models = {
        ...
        u'bccf.resource': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'Resource', '_ormbases': [u'bccf.BCCFChildPage']},
