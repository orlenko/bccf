...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.approved_on'
        db.add_column(u'bccf_campaign', 'approved_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.approved_on'
        db.delete_column(u'bccf_campaign', 'approved_on')
