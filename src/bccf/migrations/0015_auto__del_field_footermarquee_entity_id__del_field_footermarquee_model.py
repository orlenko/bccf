...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FooterMarquee.entity_id'
        db.delete_column(u'bccf_footermarquee', 'entity_id')

        # Deleting field 'FooterMarquee.model_name'
        db.delete_column(u'bccf_footermarquee', 'model_name')


        # Changing field 'BigMarquee.entity_id'
        db.alter_column(u'bccf_bigmarquee', 'entity_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'BigMarquee.model_name'
        db.alter_column(u'bccf_bigmarquee', 'model_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Adding field 'FooterMarquee.entity_id'
        db.add_column(u'bccf_footermarquee', 'entity_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'FooterMarquee.model_name'
        db.add_column(u'bccf_footermarquee', 'model_name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)


        # Changing field 'BigMarquee.entity_id'
        db.alter_column(u'bccf_bigmarquee', 'entity_id', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'BigMarquee.model_name'
        db.alter_column(u'bccf_bigmarquee', 'model_name', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))
