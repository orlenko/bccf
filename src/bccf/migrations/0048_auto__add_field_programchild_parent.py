...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProgramChild.parent'
        db.add_column(u'bccf_programchild', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=18, to=orm['bccf.Program']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProgramChild.parent'
        db.delete_column(u'bccf_programchild', 'parent_id')
    ...
    models = {
        ...
        u'bccf.programchild': {
            ...
            'content': ('mezzanine.core.fields.RichTextField', [], {}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bccf.Program']"})
        },
        u'bccf.settings': {
