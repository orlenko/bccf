...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BCCFPage.richtextpage_ptr'
        db.delete_column(u'bccf_bccfpage', u'richtextpage_ptr_id')
        ...
        # Deleting field 'BCCFChildPage.richtextpage_ptr'
        db.delete_column(u'bccf_bccfchildpage', u'richtextpage_ptr_id')

        # Adding field 'BCCFChildPage.page_ptr'
        db.add_column(u'bccf_bccfchildpage', u'page_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['pages.Page'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BCCFPage.richtextpage_ptr'
        db.add_column(u'bccf_bccfpage', u'richtextpage_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['pages.RichTextPage'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'BCCFPage.page_ptr'
        db.delete_column(u'bccf_bccfpage', u'page_ptr_id')

        # Adding field 'BCCFChildPage.richtextpage_ptr'
        db.add_column(u'bccf_bccfchildpage', u'richtextpage_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['pages.RichTextPage'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'BCCFChildPage.page_ptr'
        db.delete_column(u'bccf_bccfchildpage', u'page_ptr_id')
