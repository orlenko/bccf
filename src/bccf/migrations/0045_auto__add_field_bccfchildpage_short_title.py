...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BCCFChildPage.short_title'
        db.add_column(u'bccf_bccfchildpage', 'short_title',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BCCFChildPage.short_title'
        db.delete_column(u'bccf_bccfchildpage', 'short_title')
    ...
    models = {
        ...
        u'bccf.bccfchildpage': {
            ...
            'short_title': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
