...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.downloadableform_ptr'
        db.delete_column(u'bccf_video', u'downloadableform_ptr_id')
    ...
    def backwards(self, orm):
        # Adding field 'Video.downloadableform_ptr'
        db.add_column(u'bccf_video', u'downloadableform_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['bccf.DownloadableForm'], unique=True, primary_key=True),
                      keep_default=False)
