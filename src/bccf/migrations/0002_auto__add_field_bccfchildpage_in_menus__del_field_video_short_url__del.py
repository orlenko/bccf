...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Video.short_url'
        db.delete_column(u'bccf_video', 'short_url')

        # Deleting field 'Video.site'
        db.delete_column(u'bccf_video', 'site_id')

        # Deleting field 'Video.keywords_string'
        db.delete_column(u'bccf_video', 'keywords_string')

        # Deleting field 'Video.in_sitemap'
        db.delete_column(u'bccf_video', 'in_sitemap')

        # Deleting field 'Video.id'
        db.delete_column(u'bccf_video', u'id')

        # Deleting field 'Video.title'
        db.delete_column(u'bccf_video', 'title')

        # Deleting field 'Video.content'
        db.delete_column(u'bccf_video', 'content')

        # Deleting field 'Video.status'
        db.delete_column(u'bccf_video', 'status')

        # Deleting field 'Video.updated'
        db.delete_column(u'bccf_video', 'updated')

        # Deleting field 'Video.description'
        db.delete_column(u'bccf_video', 'description')

        # Deleting field 'Video.expiry_date'
        db.delete_column(u'bccf_video', 'expiry_date')

        # Deleting field 'Video.user'
        db.delete_column(u'bccf_video', 'user_id')

        # Deleting field 'Video.slug'
        db.delete_column(u'bccf_video', 'slug')

        # Deleting field 'Video.gen_description'
        db.delete_column(u'bccf_video', 'gen_description')

        # Deleting field 'Video.created'
        db.delete_column(u'bccf_video', 'created')

        # Deleting field 'Video._meta_title'
        db.delete_column(u'bccf_video', '_meta_title')

        # Deleting field 'Video.publish_date'
        db.delete_column(u'bccf_video', 'publish_date')

        # Adding field 'Video.bccfchildpage_ptr'
        db.add_column(u'bccf_video', u'bccfchildpage_ptr',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Video.short_url'
        db.add_column(u'bccf_video', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.site'
        db.add_column(u'bccf_video', 'site',
        ...
        # Adding field 'Video.in_sitemap'
        db.add_column(u'bccf_video', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Video.id'
        db.add_column(u'bccf_video', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Adding field 'Video.title'
        db.add_column(u'bccf_video', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=500),
                      keep_default=False)

        # Adding field 'Video.content'
        db.add_column(u'bccf_video', 'content',
                      self.gf('mezzanine.core.fields.RichTextField')(default=1),
                      keep_default=False)

        # Adding field 'Video.status'
        db.add_column(u'bccf_video', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Video.updated'
        db.add_column(u'bccf_video', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Video.description'
        db.add_column(u'bccf_video', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Video.expiry_date'
        db.add_column(u'bccf_video', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.user'
        db.add_column(u'bccf_video', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='videos', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Video.slug'
        db.add_column(u'bccf_video', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.gen_description'
        db.add_column(u'bccf_video', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Video.created'
        db.add_column(u'bccf_video', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Video._meta_title'
        db.add_column(u'bccf_video', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.publish_date'
        db.add_column(u'bccf_video', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Video.bccfchildpage_ptr'
        db.delete_column(u'bccf_video', u'bccfchildpage_ptr_id')
