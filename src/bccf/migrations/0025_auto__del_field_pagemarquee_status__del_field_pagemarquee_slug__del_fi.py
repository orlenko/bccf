...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PageMarquee.status'
        db.delete_column(u'bccf_pagemarquee', 'status')

        # Deleting field 'PageMarquee.slug'
        db.delete_column(u'bccf_pagemarquee', 'slug')

        # Deleting field 'PageMarquee.updated'
        db.delete_column(u'bccf_pagemarquee', 'updated')

        # Deleting field 'PageMarquee.description'
        db.delete_column(u'bccf_pagemarquee', 'description')

        # Deleting field 'PageMarquee.created'
        db.delete_column(u'bccf_pagemarquee', 'created')

        # Deleting field 'PageMarquee.short_url'
        db.delete_column(u'bccf_pagemarquee', 'short_url')

        # Deleting field 'PageMarquee.title'
        db.delete_column(u'bccf_pagemarquee', 'title')

        # Deleting field 'PageMarquee.site'
        db.delete_column(u'bccf_pagemarquee', 'site_id')

        # Deleting field 'PageMarquee.in_sitemap'
        db.delete_column(u'bccf_pagemarquee', 'in_sitemap')

        # Deleting field 'PageMarquee.keywords_string'
        db.delete_column(u'bccf_pagemarquee', 'keywords_string')

        # Deleting field 'PageMarquee._meta_title'
        db.delete_column(u'bccf_pagemarquee', '_meta_title')

        # Deleting field 'PageMarquee.publish_date'
        db.delete_column(u'bccf_pagemarquee', 'publish_date')

        # Deleting field 'PageMarquee.gen_description'
        db.delete_column(u'bccf_pagemarquee', 'gen_description')

        # Deleting field 'PageMarquee.expiry_date'
        db.delete_column(u'bccf_pagemarquee', 'expiry_date')
        ...
        # Deleting field 'HomeMarquee.title'
        db.delete_column(u'bccf_homemarquee', 'title')
    ...
    def backwards(self, orm):
        # Adding field 'PageMarquee.status'
        db.add_column(u'bccf_pagemarquee', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'PageMarquee.slug'
        db.add_column(u'bccf_pagemarquee', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PageMarquee.updated'
        db.add_column(u'bccf_pagemarquee', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PageMarquee.description'
        db.add_column(u'bccf_pagemarquee', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'PageMarquee.created'
        db.add_column(u'bccf_pagemarquee', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PageMarquee.short_url'
        db.add_column(u'bccf_pagemarquee', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PageMarquee.title'
        db.add_column(u'bccf_pagemarquee', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=500),
                      keep_default=False)

        # Adding field 'PageMarquee.site'
        db.add_column(u'bccf_pagemarquee', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'PageMarquee.in_sitemap'
        db.add_column(u'bccf_pagemarquee', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PageMarquee.keywords_string'
        db.add_column(u'bccf_pagemarquee', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'PageMarquee._meta_title'
        db.add_column(u'bccf_pagemarquee', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PageMarquee.publish_date'
        db.add_column(u'bccf_pagemarquee', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PageMarquee.gen_description'
        db.add_column(u'bccf_pagemarquee', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PageMarquee.expiry_date'
        db.add_column(u'bccf_pagemarquee', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'HomeMarquee.title'
        db.add_column(u'bccf_homemarquee', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=500),
                      keep_default=False)
