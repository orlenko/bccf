...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'BigMarqueeSlide'
        db.delete_table(u'bccf_bigmarqueeslide')

        # Removing M2M table for field marquee on 'BigMarqueeSlide'
        db.delete_table(db.shorten_name(u'bccf_bigmarqueeslide_marquee'))

        # Deleting model 'BigMarquee'
        db.delete_table(u'bccf_bigmarquee')
    ...
    def backwards(self, orm):
        # Adding model 'BigMarqueeSlide'
        db.create_table(u'bccf_bigmarqueeslide', (
            ('image', self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True, blank=True)),
            ('caption', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal(u'bccf', ['BigMarqueeSlide'])
        ...
        # Adding model 'BigMarquee'
        db.create_table(u'bccf_bigmarquee', (
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('entity_id', self.gf('django.db.models.fields.IntegerField')(default='', null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'bccf', ['BigMarquee'])
