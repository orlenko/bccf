...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewsPosts'
        db.create_table(u'news_newsposts', (
        ...
        db.send_create_signal(u'news', ['NewsPosts'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NewsPosts'
        db.delete_table(u'news_newsposts')
    ...
    models = {
        ...
        u'news.newsposts': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'NewsPosts', '_ormbases': [u'bccf.BCCFChildPage']},
